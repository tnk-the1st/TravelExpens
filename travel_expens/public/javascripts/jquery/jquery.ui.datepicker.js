 ...
 *
 * http://api.jqueryui.com/ympicker/
 *
 * Depends:
 *	jquery.ui.core.js
 */
...
$.extend($.ui, { ympicker: { version: "1.10.4" } });
...
$.extend(Ympicker.prototype, {
	...
	_showDatepicker: function(input) {
		...
		if ($.ympicker._isDisabledDatepicker(input) || $.ympicker._lastInput === input) { // already here
			return;
		}
...
function bindHover(dpDiv) {
	...
	return dpDiv.delegate(selector, "mouseout", function() {
		...
		.delegate(selector, "mouseover", function(){
			if (!$.ympicker._isDisabledDatepicker( instActive.inline ? dpDiv.parent()[0] : instActive.input[0])) {
