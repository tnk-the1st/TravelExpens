				...
				for (var dRow = 0; dRow < 3; dRow++) { // create date picker rows
					...
					for (var dow = 0; dow < 4; dow++) { // create date picker days
						...
						tbody += "<td class='" +
							...
							(unselectable ? "" : " data-handler='selectDay' data-event='click' data-month='" + printDate.getMonth() + "' data-year='" + printDate.getFullYear() +','+ printDate.getDate() + ', this);return false;"') + '>' +//+ "'") + ">" + // actions
